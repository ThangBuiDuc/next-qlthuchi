...
const LeftPanel = ({ selected }) => {
  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      ...
      // setMutating(false);
      Swal.fire({
        title: "Lập định mức thu cho cấp học",
        text: "Lập định mức thu cho cấp học thành công",
        icon: "success",
      });
    },
    onError: () => {
      ...
      Swal.fire({
        title: "Lập định mức thu cho cấp học",
        text: "Lập định mức thu cho cấp học không thành công",
        icon: "error",
      });
    },
  });
  ...
  const handleOnclick = useCallback(async () => {
    ...
    Swal.fire({
      title: "Lập định mức thu cho cấp học",
      text: "Bạn có chắc chắn muốn lập định mức thu cho cấp học? Những định mức thu trùng sẽ bị thay thế bằng các định mức thu mới!",
